<template>
    <main class="flex flex-col flex-auto lg:flex-row overflow-hidden">
        ...
        >
            <img
                :class="
                    showFilters ? 'section-arrow rotate-90' : 'section-arrow'
                "
                src="/icons/arrow.svg"
            />
        ...
        <div class="flex flex-col w-full overflow-hidden">
            <!-- windows tab -->
            <div
                class="tab-height w-full hidden lg:flex border-bot items-center"
            >
            ...
            <div id="tab" class="flex lg:hidden items-center">
                ...
                <p class="font-fira_regular text-white text-sm px-3">
                    projects
                </p>
...
// const keys = Object.keys(projects.value)
